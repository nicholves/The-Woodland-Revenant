...
glm::vec3 Camera::GetSide(void) const {
    ...
    glm::vec3 current_side = glm::vec3(1, 0, 0);
    return current_side;
}
...
glm::vec3 Camera::GetUp(void) const {
    ...
    glm::vec3 current_up = glm::vec3(1, 0, 0);
    return current_up;
}
...
void Camera::Yaw(float angle){
    ...
    glm::quat rotation = glm::angleAxis(angle, glm::vec3(1,0,0)); // not the correct axis
...
void Camera::Roll(float angle){
    ...
    glm::quat rotation = glm::angleAxis(angle, glm::vec3(0,1,0)); // what axis is used for rolling?
